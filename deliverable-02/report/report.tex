...
All the standard output and error are readable under the directory \texttt{./SbatchMan/sout/baldo/}. For the NVIDIA report a directory \texttt{profilatio} will be generated.
